...
const portfolioItems = [
  {
    ...
    image: '/user/documents/upload/lakovacia-linka-s-dopravnikovym-systemom-nitra.jpg',
    beforeImage: '/user/documents/upload/oplachova-kabina-s-technologickymi-nadobami-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 5.0,
  ...
  },
  {
    ...
    beforeImage: '/user/documents/upload/priprava-zabradlia-na-praskove-lakovanie-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 4.9,
  ...
  },
  {
    ...
    beforeImage: '/user/documents/upload/praskove-lakovanie-pracovneho-stola-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 4.8,
  ...
  },
  {
    ...
    image: '/user/documents/upload/praskove-lakovanie-oceloveho-rebrika-nitra.jpg',
    beforeImage: '/user/documents/upload/zaveseny-ocelovy-ram-na-praskovanie-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 4.9,
  ...
  },
  {
    ...
    beforeImage: '/user/documents/upload/cierne-praskove-lakovanie-kovovej-konstrukcie-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 5.0,
  ...
  },
  {
    ...
    image: '/user/documents/upload/vysoka-priemyselna-vypalovacia-pec-s-kolajnicou-nitra.jpg',
    beforeImage: '/user/documents/upload/priemyselna-susiaca-pec-so-zelenym-ramom-nitra.jpg',
    location: 'Nitra',
    date: '2024',
    rating: 4.9,
